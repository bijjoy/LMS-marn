...
function Features() {
    ...
    // Ensure courses is not null or undefined before mapping
    if (!courses) {
                    ...
                    <div className="row d-flex justify-content-center text-center">
                        ...
                        <div className="col-lg-7 col-12 text-light pt-2">
                            ...
                            <p className="light-300">
                                Get ready to transform yourself from zero to hero with our courses
                                <br /><a rel="noreferrer" target="_blank" href='https://www.freepik.com/vectors/mockup'>Mockup vector created by macrovector - www.freepik.com</a>
                            </p>
                        </div>
            ...
            <section className="py-5 mb-5">
                <div className="container">
                    ...
                    <div className="row gy-5 g-lg-5 mb-4">
                        {courses.map(course => (
                            <CourseBox
                                key={course._id} // Assuming course._id is unique
